...
const PREDEFINED_ALERTES = [
  ...
  // Déclarations
  // Art. 128 CGI Tome 1 Chapitre 4 - Déclaration d'existence (IS et IBA)
  { type: 'OBLIGATION', categorie: 'DECLARATIONS', titre: 'Déclaration d\'existence IS / IBA', description: 'Les contribuables soumis à l\'impôt sur les sociétés et à l\'impôt sur les bénéfices d\'affaires doivent souscrire une déclaration d\'existence auprès de leur résidence fiscale dans les 15 jours qui suivent le début de leurs opérations.', articleNumero: '128' },
  { type: 'ECHEANCE', categorie: 'DECLARATIONS', titre: 'Délai de déclaration d\'existence', description: 'Déclaration d\'existence à souscrire dans les 15 jours suivant le début des opérations.', valeur: '15', unite: 'jour', articleNumero: '128' },
  // Art. 130 CGI Tome 1 Chapitre 4 - Télédéclaration et télépaiement
  { type: 'OBLIGATION', categorie: 'DECLARATIONS', titre: 'Télédéclaration et télépaiement', description: 'Les entreprises soumises au régime du réel doivent procéder à la télédéclaration et au télépaiement de leurs impôts, droits et taxes. Les états financiers doivent être attestés et certifiés par un expert-comptable en l\'absence de commissaire aux comptes.', articleNumero: '130' },
  { type: 'SANCTION', categorie: 'SANCTIONS', titre: 'Pénalité défaut de télédéclaration', description: 'Le non-respect de l\'obligation de télédéclaration est sanctionné par une pénalité de 10 % du montant à déclarer.', valeur: '10', unite: '%', articleNumero: '130' },
  // Art. 131 CGI Tome 1 Chapitre 4 - Déclaration statistique et fiscale annuelle
  { type: 'OBLIGATION', categorie: 'DECLARATIONS', titre: 'Déclaration statistique et fiscale (DSF) annuelle', description: 'Les contribuables IS et IBA doivent déclarer leur résultat fiscal annuel à l\'appui de trois jeux complets d\'états financiers OHADA (bilan, compte de résultat, tableau des flux de trésorerie, notes annexes), produits également sur support électronique. La comptabilité doit être tenue au Congo et conservée 10 ans.', articleNumero: '131' },
