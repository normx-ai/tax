    ...
    <View style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={{ alignItems: "center", padding: 20, paddingBottom: 60 }}>
        ...
        <View style={{
          ...
          <Paragraph colors={colors}>
            Conformément aux articles L.612-1 et suivants du Code de la consommation, en cas de litige non résolu par le service client ({COMPANY.contact.info}), le Consommateur peut recourir gratuitement à un médiateur de la consommation.{"\n\n"}
