    ...
    <SimulateurLayout
      ...
      exportData={result ? {
        ...
        results: [
          ...
          { label: "Loyer annuel", value: formatNumber(result.loyerAnnuel) + "", type: "normal" },
          { label: "Loyer mensuel", value: formatNumber(result.loyerMensuel) + "", type: "normal" },
          { label: "Taux", value: result.taux + "%", type: "normal" },
          { label: "Taxe", value: "", type: "header" },
          { label: "Taxe annuelle", value: formatNumber(result.taxeAnnuelle) + "", type: "result" },
          { label: "Taxe mensuelle", value: formatNumber(result.taxeMensuelle) + "", type: "normal" },
          { label: "Repartition", value: "", type: "header" },
          { label: "Part Etat", value: formatNumber(result.partEtat) + "", type: "normal" },
          { label: "Part collectivites", value: formatNumber(result.partCollectivites) + "", type: "normal" },
          { label: "Penalite retard", value: formatNumber(result.penaliteRetard) + "", type: "normal" },
          { label: "Total avec penalite", value: formatNumber(result.taxeAnnuelle + result.penaliteRetard) + "", type: "total" },
        ],
