    ...
    <SimulateurLayout
      ...
      exportData={result ? {
        ...
        results: [
          ...
          { label: "Benefice arrondi", value: formatNumber(result.beneficeArrondi) + "", type: "normal" },
          { label: "Taux IS", value: result.tauxIS + "%", type: "normal" },
          { label: "IS a payer", value: formatNumber(result.isCalcule) + "", type: "result" },
          { label: "Total acomptes", value: formatNumber(result.totalAcomptes) + "", type: "normal" },
          { label: result.creditImpot ? "Credit d'impot" : "Solde a payer", value: formatNumber(Math.abs(result.solde)) + "", type: "total" },
        ],
